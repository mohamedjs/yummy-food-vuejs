            ...
            <form method="POST" action="{{ route('register') }}">
                @csrf
							<div class="form-group mb-lg">
								<label>Name</label>
								<input name="name" type="text" class="form-control input-lg {{ $errors->has('name') ? ' is-invalid' : '' }}" />
                @if ($errors->has('name'))
                ...
                @endif
							...
							<div class="form-group mb-lg">
								...
								<input name="email" type="email" class="form-control input-lg {{ $errors->has('email') ? ' is-invalid' : '' }}" />
                @if ($errors->has('email'))
                    <span class="invalid-feedback" role="alert">
                ...
                @endif
                    ...
                    @endif
									...
									<div class="col-sm-6 mb-lg">
										...
										<input name="password-confirm" id="password-confirm" type="password" class="form-control input-lg" />
									</div>
								</div>
							</div>
